...
import { Heart, Plus, Search, Calendar, Star } from "lucide-react";
...
const LifeSkillsObsDashboard: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const res = await api.get("/life-skills-obs");
    ...
    const newPath = teacherId
        ? `/leader/life-skills-obs/new?teacherId=${teacherId}`
        : "/leader/life-skills-obs/new";
                                    ...
                                    >
                                        ...
                                        <span>
                                            <Badge variant={obs.discussedWithTeacher ? "default" : "secondary"} className="text-xs">
                                                {obs.discussedWithTeacher ? "Yes" : "No"}
                                            </Badge>
                                        </span>
                                    </div>
                                ))
